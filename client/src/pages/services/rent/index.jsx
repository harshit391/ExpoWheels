        ...
        <div className="p-4 flex flex-col gap-4">
            ...
            <div className="flex gap-4 flex-wrap">
                ...
                <input
                    ...
                    className="border p-2 rounded"
                    onChange={(e) =>
                        handleFilterChange("minRentPrice", e.target.value)
                    }
                />
                <input
                    type="number"
                    ...
                    className="border p-2 rounded"
                    onChange={(e) =>
                        handleFilterChange("maxRentPrice", e.target.value)
                    }
                />
                <input
                    type="number"
            ...
            {setNoCars && (
                ...
                className="text-2xl text-center">No Cars Available</h1>
            )}
